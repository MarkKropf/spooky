...
var emitter = new EventEmitter();
  ...
  var channelDimmer = function(startAddress,channel,level) {
    level = level * 255;
    var address = startAddress + parseInt(channel,null) -1;
